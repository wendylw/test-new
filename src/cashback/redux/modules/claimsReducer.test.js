...
describe('src/cashback/redux/modules/claim.js:reducers', () => {
  ...
  it('fetch and create cashback request', () => {
    ...
    expect(claimReducers, { type: types.FETCH_CASHBACKINFO_REQUEST }).toEqual(expectedState);
    expect(claimReducers, { type: types.CREATE_CASHBACKINFO_REQUEST }).toEqual(expectedState);
  });
  ...
  it('fetch and create cashback failure', () => {
    ...
    expect(claimReducers, { type: types.FETCH_CASHBACKINFO_FAILURE }).toEqual(expectedState);
    expect(claimReducers, { type: types.CREATE_CASHBACKINFO_FAILURE }).toEqual(expectedState);
  });

  it('FETCH_RECEIPTNUMBER_REQUEST', () => {
    const expectedState = { ...initialState, isFetching: true };
    expect(claimReducers, { type: types.FETCH_RECEIPTNUMBER_REQUEST }).toEqual(expectedState);
  });

  it('FETCH_RECEIPTNUMBER_FAILURE', () => {
    const expectedState = { ...initialState, isFetching: false };
    expect(claimReducers, { type: types.FETCH_RECEIPTNUMBER_FAILURE }).toEqual(expectedState);
  });
  ...
  it('FETCH_CASHBACKINFO_SUCCESS', () => {
    ...
    expect(claimReducers, action).toEqual(expectedState);
  });
  ...
  it('default', () => {
    expect(claimReducers, { type: 'default' }).toEqual({ ...initialState });
  });
});
