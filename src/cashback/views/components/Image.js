...
/**
 * We did not use domain compression here.
 */
// const imageS3Domain = process.env.REACT_APP_IMAGE_S3_DOMAIN;
// const imageCompressionDomain = process.env.REACT_APP_IMAGE_COMPRESSION_DOMAIN;
