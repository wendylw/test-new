...
function Skeleton({
  ...
  for (let i = 0; i < countCeil; i++) {
    ...
    if (inline) {
      ...
      // `width` is specified
      elements.push(React.createElement(React.Fragment, { key: i }, skeletonSpan, React.createElement('br', null)));
    }
  }
  return React.createElement(
    ...
    Wrapper ? elements.map((el, i) => React.createElement(Wrapper, { key: i }, el)) : elements
  );
}
