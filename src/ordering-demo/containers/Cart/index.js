...
class Cart extends Component {
  ...
  render() {
    ...
    const { summary, items } = shoppingCart;
    ...
    return (
      <section className={`table-ordering__order` /* hide */}>
        ...
        >
          ...
          <h2 className="header__title font-weight-bold text-middle">{`Order ${summary.count || 0} Items`}</h2>
        ...
        <div className="list__container">
          <CartList
            ...
            removeShoppingCartItem={this.handleRemoveCartItem}
            addOrUpdateShoppingCartItem={this.handleAddOrUpdateShoppingCartItem}
          />
        </div>
