...
describe('src/ordering/redux/modules/home: actions and reducers', () => {
  ...
  describe('loadProductList', () => {
    describe('fetchingOnlineCategory', () => {
      it(':FETCH_ONLINECATEGORY_SUCCESS', async () => {
        ...
        // mock fetch response
        fetch.mockResponseOnce(JSON.stringify(fetchOnlineCategoryData));
        // dispatch action
  ...
  describe('loadShoppingCart', () => {
    it('fetchShoppingCart', async () => {
      ...
      fetch.mockResponseOnce(JSON.stringify(fetchShoppingCartData));
  ...
  it('removeShoppingCartItem', async () => {
    ...
    fetch.mockResponseOnce(JSON.stringify(RemoveShoppingCartItemData));
  ...
  it('addOrUpdateShoppingCartItem', async () => {
    const expectedState = { ...testStore.getState().home };
    fetch.mockResponseOnce(JSON.stringify(AddOrUpdateShoppingCartItemData));
  ...
  describe('increaseProductInCart', () => {
    ...
    it('currentProduct not equal productParams', async () => {
      ...
      if (currentProduct.id !== productParams.id) {
        ...
        fetch.mockResponseOnce(JSON.stringify(fetchProductDetailData));
