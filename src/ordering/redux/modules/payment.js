...
export const types = {
  ...
  // getBraintreeToken
  FETCH_BRAINTREE_TOKEN_REQUEST: 'REDUX_DEMO/PAYMENT/FETCH_BRAINTREE_TOKEN_REQUEST',
  FETCH_BRAINTREE_TOKEN_SUCCESS: 'REDUX_DEMO/PAYMENT/FETCH_BRAINTREE_TOKEN_SUCCESS',
  FETCH_BRAINTREE_TOKEN_FAILURE: 'REDUX_DEMO/PAYMENT/FETCH_BRAINTREE_TOKEN_FAILURE',

  // getBankList
  FETCH_BANKLIST_REQUEST: 'REDUX_DEMO/PAYMENT/FETCH_BANKLIST_REQUEST',
  FETCH_BANKLIST_SUCCESS: 'REDUX_DEMO/PAYMENT/FETCH_BANKLIST_SUCCESS',
  FETCH_BANKLIST_FAILURE: 'REDUX_DEMO/PAYMENT/FETCH_BANKLIST_FAILURE',
};
