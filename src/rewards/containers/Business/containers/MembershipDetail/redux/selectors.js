...
export const getLoadPromoListData = () => state.business.membershipDetail.loadPromoListRequest.data;

export const getLoadPromoListStatus = () => state.business.membershipDetail.loadPromoListRequest.status;

export const getLoadPromoListError = () => state.business.membershipDetail.loadPromoListRequest.error;
