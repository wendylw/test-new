...
import { UNIQUE_PROMO_APPLIED_SOURCES } from '../utils/constants';
 ...
 * Derived selectors
 */
export const getMyRewardDiscount = createSelector(
...
export const getMyRewardExpiringDate = createSelector(
  getMyRewardValidTo,
  getMerchantCountry,
  (myRewardValidTo, merchantCountry) => formatTimeToDateString(merchantCountry, myRewardValidTo)
);

export const getMyRewardMinSPendPrice = createSelector(
  getMyRewardMinSpendAmount,
  getMerchantCountry,
  getMerchantCurrency,
  getMerchantLocale,
  (myRewardMinSpendAmount, merchantCountry, merchantCurrency, merchantLocale) =>
    getPrice(myRewardMinSpendAmount, {
      country: merchantCountry,
      currency: merchantCurrency,
      locale: merchantLocale,
    })
